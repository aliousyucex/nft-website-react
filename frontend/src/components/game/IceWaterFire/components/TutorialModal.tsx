  ...
  const steps = [
    {
      ...
      content: (
        <ContentWrapper>
          ...
          <InfoText>Each player has their own deck of 9 cards with different types and values.</InfoText>
        </ContentWrapper>
      ),
    },
    {
      ...
      content: (
        <ContentWrapper>
          ...
          <WarningBox>
            ...
            <WarningText>In case of a draw, cards are still consumed but no points are awarded!</WarningText>
          </WarningBox>
        </ContentWrapper>
      ),
    },
        ...
        <ContentWrapper>
          ...
          <PenaltyList>
            ...
            <PenaltyItem>
              <PenaltyIcon>⏳</PenaltyIcon>
              <PenaltyText>
                <strong>Disconnect:</strong> 10 seconds to reconnect, or you forfeit and lose your bet
              </PenaltyText>
            </PenaltyItem>
            <PenaltyItem>
              <PenaltyIcon>🎯</PenaltyIcon>
